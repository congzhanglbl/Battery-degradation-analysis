...
set(gca,'xlim',[0,length(Power_vehicle_vector)],'xTick',[0:100:length(Power_vehicle_vector)]); %Éè¶¨×ó±ß²àx×ø±ê·¶Î§
set(g,'linewidth',2); %×ø±êÏß´Ö0.5°õ
set(g,'linestyle','-','color','g');        
set(h,'linewidth',2); %×ø±êÏß´Ö0.5°õ
set(h,'linestyle','-','color','r');
set(f,'linewidth',2); %×ø±êÏß´Ö0.5°õ
